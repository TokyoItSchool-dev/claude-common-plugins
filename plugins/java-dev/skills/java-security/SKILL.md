---
name: java-security
description: Java security practices covering secret management, SQL injection prevention, input validation, authentication/authorization, dependency scanning, and safe error handling. Use when writing or editing Java files (*.java) that handle user input, credentials, database queries, or external calls. Not for general coding style (see java-conventions) or test code (see java-testing).
---
...
- Run `./mvnw dependency:tree` or `./gradlew dependencies` to audit transitive dependencies
...
Derived from the open-source ECC plugin (https://github.com/affaan-m/ECC, v2.0.0) `rules/java/security.md`, adapted.
